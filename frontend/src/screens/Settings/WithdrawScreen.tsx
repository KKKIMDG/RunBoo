...
export default function WithdrawScreen({ navigation }: any) {
  ...
  const submitWithdraw = async () => {
    try {
      ...
      const message = e?.message ?? "계정 탈퇴 처리 중 오류가 발생했습니다.";
        ...
        >
          ...
          <View style={styles.noticeBox}>
            ...
            <View style={styles.noticeTextWrapper}>
              ...
              <Text style={styles.noticeDesc}>
                탈퇴 시 모든 데이터는 복구할 수 없으며, 탈퇴 후 한 달간 동일
                이메일로 재가입이 불가합니다.
              </Text>
            </View>
          </View>
          ...
          <TouchableOpacity
            style={[
              ...
              (loading || (isLocal && password.trim().length === 0)) &&
                styles.withdrawButtonDisabled,
            ]}
            disabled={loading || (isLocal && password.trim().length === 0)}
