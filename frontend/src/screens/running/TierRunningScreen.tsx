...
const TierRunningScreen = () => {
    ...
    const blurredMapStyle: MapStyleElement[] = [
        { elementType: "geometry", stylers: [{ color: isDarkMode ? "#242f3e" : "#f0f0f0" }] },
        {
            featureType: "road",
        ...
        { featureType: "water", elementType: "geometry", stylers: [{ color: isDarkMode ? "#17263c" : "#c9d1d9" }] },
    ];
        ...
        () => (
            <View style={StyleSheet.absoluteFill}>
                <MapView
                    ...
                    customMapStyle={Platform.OS === "android" ? blurredMapStyle : undefined}
                    onPanDrag={() => setIsTracking(false)}
                    initialRegion={
                        initialLocation
                            ? { ...initialLocation, latitudeDelta: 0.002, longitudeDelta: 0.002 }
                            : { latitude: 37.5665, longitude: 126.978, latitudeDelta: 0.002, longitudeDelta: 0.002 }
                    }
                />
                <View
                    style={[
                        ...
                        {
                            backgroundColor: isDarkMode ? "rgba(0,0,0,0.15)" : "rgba(255,255,255,0.1)",
                        },
                    ]}
                    pointerEvents="none"
                />
        ...
        <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
                <View style={styles.header}>
                    <View style={[styles.statusTag, { backgroundColor: "#4A6EA9", borderWidth: 0 }]}>
                ...
                <View style={styles.statsContainer}>
                    ...
                    />
                    <StatBox
                        icon={<MaterialCommunityIcons name="target" size={20} color="#2D3269" />}
                        label="남은 거리"
                    ...
                    />
                    <StatBox
                        icon={<MaterialCommunityIcons name="shoe-print" size={20} color="#8E8E93" />}
                        label="케이던스"
                ...
                <View style={styles.chartCard}>
                    ...
                    <LineChart
                        data={{ labels: [], datasets: [{ data: paceHistory.length > 0 ? paceHistory : [0] }] }}
                        width={width - 80}
                        height={150}
                ...
                <View style={styles.mapContainer}>
                    ...
                    <TouchableOpacity
                        style={[
                            ...
                            {
                                backgroundColor: isTracking ? "#4A6EA9" : isDarkMode ? "#333" : "#FFF",
                            },
                        ]}
            ...
            {!isReady && (
                <View style={styles.controlContainer}>
                    <TouchableOpacity style={styles.pauseButton} onPress={isPaused ? resumeRun : pauseRun}>
                        <Ionicons name={isPaused ? "play" : "pause"} size={36} color="#4A6EA9" />
                    </TouchableOpacity>
