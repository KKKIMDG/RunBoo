...
const RunningScreen = () => {
    ...
    const { isFollowing, onLocationUpdate, handleFocusPress, setIsFollowing } =
        mapFocusing;
    ...
    }, [routeCoordinates, onLocationUpdate]);
    ...
    // cadence 샘플을 훅에 전달해서 평균 계산/DB 저장에 사용
    useEffect(() => {
        if (cadence > 0) {
    ...
    }, [isReady, isVoiceEnabled, speakStart]);
    ...
    }, [distance, isPaused, isReady, isVoiceEnabled, isMale, checkAndSpeak]);
    ...
    }, [isPaused, isReady, isVoiceEnabled, speakPause, speakResume]);
    ...
    const renderedMap = useMemo(
        ...
        [initialLocation, isDarkMode, isFollowing, colorScheme, routeCoordinates, setIsFollowing],
    );
