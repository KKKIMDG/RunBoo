        ...
        <SafeAreaView style={s.overlay} edges={["top", "bottom"]}>
            <View style={s.popupContainer}>
                            ...
                            >
                                ...
                                {startCoord && (
                                    <Marker coordinate={startCoord} anchor={{ x: 0.5, y: 0.5 }}>
                                        <View style={s.markerCircle}>
                                            <View style={[s.markerInner, { backgroundColor: "#4CAF50" }]} />
                                        </View>
                                    </Marker>
                                )}
                                ...
                                {endCoord && (
                                    <Marker coordinate={endCoord} anchor={{ x: 0.5, y: 0.5 }}>
                                        <View style={s.markerCircle}>
                                            <View style={[s.markerInner, { backgroundColor: "#FF3B30" }]} />
                                        </View>
                                    </Marker>
                                )}
                            </MapView>

                            <TouchableOpacity style={s.focusButton} onPress={handleFocusRoute} activeOpacity={0.85}>
                                <MaterialCommunityIcons name="altimeter" size={22} color="#4A6EA9" />
                            </TouchableOpacity>
                        </View>
                    ) : (
                ...
                <View style={s.infoContent}>
                    <View style={s.grid}>
                        <View style={s.card}>
                            <MaterialCommunityIcons name="map-marker-distance" size={22} color="#111827" />
                            <Text style={s.cardLabel}>거리</Text>
                            <Text style={s.cardValue}>
                                {data?.distanceM != null ? (data.distanceM / 1000).toFixed(2) : "-"}
